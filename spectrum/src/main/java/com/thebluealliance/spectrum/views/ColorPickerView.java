...
import com.thebluealliance.spectrum.util.Utils;
...
public class ColorPickerView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        mColorWheelThickness = Utils.dpToPx(8);
        mColorWheelRadius = Utils.dpToPx(124);
        mPreferredColorWheelRadius = mColorWheelRadius;
        mColorCenterRadius = Utils.dpToPx(54);
        mPreferredColorCenterRadius = mColorCenterRadius;
        mColorCenterHaloRadius = Utils.dpToPx(60);
        mPreferredColorCenterHaloRadius = mColorCenterHaloRadius;
        mColorPointerRadius = Utils.dpToPx(14);
        mColorPointerHaloRadius = Utils.dpToPx(18);
